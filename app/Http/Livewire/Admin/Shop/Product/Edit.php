...
class Edit extends Component
{
    ...
    public function edit()
    {
        ...
        $this->emitTo(\App\Http\Livewire\Admin\Shop\Product\Index::getName(), 'updateList');
        $this->emit('hideModal');
    ...
    public function render()
    {
        ...
        return view('livewire.admin.shop.product.edit', compact('brands', 'types'));
    }
}
