...
<main class="{{ config('bap.container', 'container-fluid') }}">
        ...
        <div class="row align-items-center">
            <div class="col">
                ...
                <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.content.faq.index') }}">{{ __('bap.faqs') }}</a></li>
                </ol>
            </div>
            @can('admin_faq_create')
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <button wire:click="$dispatch('showModal', {data:{alias:'admin.content.f-a-q.create'}})" class="btn btn-primary d-none d-sm-inline-block">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                            {{ __('bap.create_faq') }}
                        </button>
                        <button wire:click="$dispatch('showModal', {data:{alias:'admin.content.f-a-q.create'}})" class="btn btn-primary d-sm-none btn-icon" aria-label="Create new report">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                        </button>
                    </div>
                </div>
    ...
    <div class="page-body">
        ...
        <div class="card-header">
            <h3 class="card-title">{{ __('bap.faqs') }}</h3>
        </div>
        <div class="card-body">
            <div class="d-flex">
        ...
        <div class="table-responsive">
            <table class="table card-table table-vcenter text-nowrap datatable">
                ...
                <tr>
                    ...
                    <th wire:click="sortByColumn('question')">{{ __('bap.question') }}
                    ...
                    <th wire:click="sortByColumn('answer')">{{ __('bap.answer') }}
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                @can('admin_article_edit')
                                    <button wire:click="$dispatch('showModal', 'admin.content.f-a-q.edit', '{{ json_encode($faq->id) }}')" class="btn btn-primary btn-icon btn-sm">
