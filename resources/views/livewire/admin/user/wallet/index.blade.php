                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col text-end">
                                        ...
                                        <button  wire:click="updateBalance({{ $wallet->id }})" class="btn btn-info btn-sm">
                                            <!-- Download SVG icon from http://tabler-icons.io/i/rotate -->
                                        ...
                                        <button onclick="Livewire.emit('showModal', 'admin.user.wallet.transactions', '{{ $wallet->id }}')" class="btn btn-danger btn-sm">
                                        ...
                                        <button  onclick="Livewire.emit('showModal', 'admin.user.wallet.create-transaction', '{{ $wallet->id }}')" class="btn btn-success btn-sm">
