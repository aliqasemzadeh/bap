                        ...
                        @foreach(\Cart::getContent() as $item)
                            <div class="list-group-item">
                                <div class="row align-items-center">
                                    <div class="col-auto"><span class="avatar me-2" style="background-image: url( {{ $item->attributes->icon }} )"></span></div>
                                    <div class="col text-truncate">
                                        <a href="{{ route('shop.product.view', [$item->id]) }}" class="text-body d-block">{{ $item->name }}</a>
