<div class="navbar-nav flex-row order-md-last">
    <div class="nav-item dropdown me-3">
        <svg x-show="!darkTheme" x-on:click="darkTheme = ! darkTheme" xmlns="http://www.w3.org/2000/svg" class="icon"
    ...
    <div class="nav-item dropdown me-3">
        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-language" width="24" height=24" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
            <path d="M4 5h7" />
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col text-truncate">
                                                <a href="{{ route('notification.view', [$notification->id]) }}"
                                                   class="text-body d-block">{{ $notification->data['title'] }}</a>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
