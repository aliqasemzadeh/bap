...
<head>
    ...
    <title>@if(isset($title))
            {{ $title }} -
        @endif{{ config('bap.name', 'BAP') }}</title>
    ...
    <header class="navbar navbar-expand-md navbar-dark d-print-none">
        <div class="{{ config('bap.container-app', 'container') }}">
            ...
            <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                <a href="{{ route('home') }}">
                    <img x-show="darkTheme == 'dark'" src="{{ asset('images/logo-dark.svg') }}" width="110" height="32"
                         alt="{{ config('app.name', 'Laravel') }}" class="navbar-brand-image">
                    <img x-show="darkTheme != 'dark'" src="{{ asset('images/logo-light.svg') }}" width="110" height="32"
                         alt="{{ config('app.name', 'Laravel') }}" class="navbar-brand-image">
                </a>
            </h1>
                                    ...
                                    <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
	                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                             ...
                                             stroke-linecap="round" stroke-linejoin="round"><path stroke="none"
                                                                                                  d="M0 0h24v24H0z"
                                                                                                  fill="none"/><circle
                                                    cx="12" cy="13" r="2"/><line x1="13.45" y1="11.55" x2="15.5"
                                                                                 y2="9.5"/><path
